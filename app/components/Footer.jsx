...
const Footer = () => {
  ...
  return (
    <div className={`w-full flex justify-between items-center p-5 ${darkMode ? 'bg-black text-white' : 'bg-white text-black'} `}>    
        <div>
            copyright &#169; Sleima Ducros
        </div>

        <div className=' flex justify-center items-center gap-5 '>
            <div className=' font-normal'> socials :</div> 
            <div>
